package io.antmedia.android.mqtt;
...
//                mMqqtClientStatus = MqqtConnectionStatus.DISCONNECTING;
    ...
    public void onFailure(IMqttToken iMqttToken, Throwable throwable) {
        ...
        String errorText = mContext.getString(io.antmedia.android.liveVideoBroadcaster.R.string.mqtt_connection_failed)+". "+throwable.getLocalizedMessage();
    ...
    public void connectionLost(Throwable throwable) {
        ...
        if (throwable != null) {        // if disconnected because a reason show toast. Standard disconnect will have a null throwable
            Toast.makeText(mContext, io.antmedia.android.liveVideoBroadcaster.R.string.mqtt_connection_lost, Toast.LENGTH_LONG).show();
        }
