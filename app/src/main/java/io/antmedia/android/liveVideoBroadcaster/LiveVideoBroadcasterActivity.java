...
import io.antmedia.android.PinIOActivity;
...
public class LiveVideoBroadcasterActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (!mIsRecording) {
                    System.out.println("acxx");
                    if (mLiveVideoBroadcaster != null) {
                        System.out.println("acxx");
                        if (!mLiveVideoBroadcaster.isConnected()) {

                            System.out.println("acxxg");
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (mIsRecording) {
                    ...
                    Intent i = new Intent(LiveVideoBroadcasterActivity.this, PinIOActivity.class);
                    i.putExtra("flag","B");
                    startActivity(i);
                }
