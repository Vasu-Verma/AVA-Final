...
import io.antmedia.android.ble.BleDevicesScanner;
import io.antmedia.android.ble.BleManager;
import io.antmedia.android.ble.BleUtils;
import io.antmedia.android.settings.SettingsActivity;
import io.antmedia.android.ui.utils.DialogUtils;
import io.antmedia.android.ui.utils.ExpandableHeightExpandableListView;
import io.antmedia.android.update.FirmwareUpdater;
import io.antmedia.android.update.ReleasesParser;
...
public class MainActivity extends AppCompatActivity implements BleManager.BleManagerListener, BleUtils.ResetBluetoothAdapterListener, FirmwareUpdater.FirmwareUpdaterListener {
    ...
    private final static int kComponentsNameIds[] = {
            io.antmedia.android.liveVideoBroadcaster.R.string.scan_connectservice_info,
            io.antmedia.android.liveVideoBroadcaster.R.string.scan_connectservice_uart,
            io.antmedia.android.liveVideoBroadcaster.R.string.scan_connectservice_pinio,
            io.antmedia.android.liveVideoBroadcaster.R.string.scan_connectservice_controller,
            io.antmedia.android.liveVideoBroadcaster.R.string.scan_connectservice_beacon,
            io.antmedia.android.liveVideoBroadcaster.R.string.scan_connectservice_neopixel,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // UI
        mScannedDevicesListView = (ExpandableHeightExpandableListView) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.scannedDevicesListView);
        ...
        mScanButton = (Button) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.scanButton);

        mNoDevicesTextView = (TextView) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.nodevicesTextView);
        mDevicesScrollView = (ScrollView) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.devicesScrollView);
        mDevicesScrollView.setVisibility(View.GONE);

        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.swipeRefreshLayout);
        ...
        mFiltersPanelView = findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.filtersExpansionView);
        mFiltersExpandImageView = (ImageView) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.filtersExpandImageView);
        mFiltersClearButton = (ImageButton) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.filtersClearButton);
        mFiltersTitleTextView = (TextView) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.filtersTitleTextView);
        mFiltersNameEditText = (EditText) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.filtersNameEditText);
        ...
        mFiltersRssiSeekBar = (SeekBar) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.filtersRssiSeekBar);
        ...
        mFiltersRssiValueTextView = (TextView) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.filtersRssiValueTextView);
        mFiltersUnnamedCheckBox = (CheckBox) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.filtersUnnamedCheckBox);
        ...
        mFiltersUartCheckBox = (CheckBox) findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.filtersUartCheckBox);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(io.antmedia.android.liveVideoBroadcaster.R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == io.antmedia.android.liveVideoBroadcaster.R.id.action_help) {
            startHelp();
            return true;
        } else if (id == io.antmedia.android.liveVideoBroadcaster.R.id.action_settings) {
    ...
    public void onBackPressed() {
        if (mShouldEnableWifiOnQuit) {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(getString(io.antmedia.android.liveVideoBroadcaster.R.string.settingsaction_confirmenablewifi_title))
                    .setMessage(getString(io.antmedia.android.liveVideoBroadcaster.R.string.settingsaction_confirmenablewifi_message))
    ...
    private void openFiltersPanel(final boolean isOpen, boolean animated) {
        ...
        mFiltersExpandImageView.setImageResource(isOpen ? io.antmedia.android.liveVideoBroadcaster.R.drawable.ic_expand_less_black_24dp : io.antmedia.android.liveVideoBroadcaster.R.drawable.ic_expand_more_black_24dp);
...
*/
    ...
    public void onClickFilterNameSettings(View view) {
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case io.antmedia.android.liveVideoBroadcaster.R.id.scanfilter_name_contains:
                        mPeripheralList.setFilterNameExact(false);
                        break;
                    case io.antmedia.android.liveVideoBroadcaster.R.id.scanfilter_name_exact:
                        mPeripheralList.setFilterNameExact(true);
                        break;
                    case io.antmedia.android.liveVideoBroadcaster.R.id.scanfilter_name_sensitive:
                        mPeripheralList.setFilterNameCaseInsensitive(false);
                        break;
                    case io.antmedia.android.liveVideoBroadcaster.R.id.scanfilter_name_insensitive:
        ...
        inflater.inflate(io.antmedia.android.liveVideoBroadcaster.R.menu.menu_scan_filters_name, menu);
        final boolean isFilterNameExact = mPeripheralList.isFilterNameExact();
        menu.findItem(isFilterNameExact ? io.antmedia.android.liveVideoBroadcaster.R.id.scanfilter_name_exact : io.antmedia.android.liveVideoBroadcaster.R.id.scanfilter_name_contains).setChecked(true);
        final boolean isFilterNameCaseInsensitive = mPeripheralList.isFilterNameCaseInsensitive();
        menu.findItem(isFilterNameCaseInsensitive ? io.antmedia.android.liveVideoBroadcaster.R.id.scanfilter_name_insensitive : io.antmedia.android.liveVideoBroadcaster.R.id.scanfilter_name_sensitive).setChecked(true);
        popup.show();
    }
    ...
    private void updateFiltersTitle() {
        ...
        mFiltersTitleTextView.setText(filtersTitle != null ? String.format(Locale.ENGLISH, getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_filters_title_filter_format), filtersTitle) : getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_filters_title_nofilter));
    ...
    private void updateRssiValue() {
        ...
        mFiltersRssiValueTextView.setText(String.format(Locale.ENGLISH, getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_filters_rssi_value_format), value));
    }
    ...
    private void showChooseDeviceServiceDialog(final BluetoothDeviceData deviceData) {
        ...
        String title = String.format(getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_connectto_dialog_title_format), deviceData.getNiceName());
    ...
    private boolean manageBluetoothAvailability() {
        ...
        switch (bleStatus) {
            case BleUtils.STATUS_BLE_NOT_AVAILABLE:
                errorMessageId = io.antmedia.android.liveVideoBroadcaster.R.string.dialog_error_no_ble;
                isEnabled = false;
                break;
            case BleUtils.STATUS_BLUETOOTH_NOT_AVAILABLE: {
                errorMessageId = io.antmedia.android.liveVideoBroadcaster.R.string.dialog_error_no_bluetooth;
    ...
    private boolean manageLocationServiceAvailabilityForScanning() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {        // Location services are only needed to be enabled from Android 6.0
            ...
            if (!areLocationServiceReady) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                AlertDialog dialog = builder.setMessage(io.antmedia.android.liveVideoBroadcaster.R.string.dialog_error_nolocationservices_requiredforscan_marshmallow)
                        .setPositiveButton(android.R.string.ok, null)
                        .show();
                DialogUtils.keepDialogOnOrientationChanges(dialog);
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == kActivityRequestCode_ConnectedActivity) {
            if (resultCode < 0) {
                Toast.makeText(this, io.antmedia.android.liveVideoBroadcaster.R.string.scan_unexpecteddisconnect, Toast.LENGTH_LONG).show();
            }
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                AlertDialog dialog = builder.setMessage(io.antmedia.android.liveVideoBroadcaster.R.string.dialog_error_no_bluetooth)
                        .setPositiveButton(android.R.string.ok, null)
                        .show();
                DialogUtils.keepDialogOnOrientationChanges(dialog);
    ...
    private void showConnectionStatus(boolean enable) {
        showStatusDialog(enable, io.antmedia.android.liveVideoBroadcaster.R.string.scan_connecting);
    }

    private void showGettingUpdateInfoState() {
        showConnectionStatus(false);
        showStatusDialog(true, io.antmedia.android.liveVideoBroadcaster.R.string.scan_gettingupdateinfo);
    }
...
//            Log.d(TAG, "record -> lenght: " + length + " type:" + type + " data" + data);
    ...
    private void updateUI() {
        // Scan button
        boolean isScanning = mScanner != null && mScanner.isScanning();
        mScanButton.setText(getString(isScanning ? io.antmedia.android.liveVideoBroadcaster.R.string.scan_scanbutton_scanning : io.antmedia.android.liveVideoBroadcaster.R.string.scan_scanbutton_scan));
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    new AlertDialog.Builder(MainActivity.this)
                            .setTitle(io.antmedia.android.liveVideoBroadcaster.R.string.scan_failedupdatedetected_title)
                            .setMessage(io.antmedia.android.liveVideoBroadcaster.R.string.scan_failedupdatedetected_message)
                            .setPositiveButton(io.antmedia.android.liveVideoBroadcaster.R.string.scan_failedupdatedetected_ok, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
    ...
    public void onFirmwareUpdatesChecked(boolean isUpdateAvailable, final ReleasesParser.FirmwareInfo latestRelease, FirmwareUpdater.DeviceInfoData deviceInfoData, Map<String, ReleasesParser.BoardInfo> allReleases) {
        ...
        if (isUpdateAvailable) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    // Ask user if should update
                    String message = String.format(getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_softwareupdate_messageformat), latestRelease.version);
                    new AlertDialog.Builder(MainActivity.this)
                            .setTitle(io.antmedia.android.liveVideoBroadcaster.R.string.scan_softwareupdate_title)
                            .setMessage(message)
                            .setPositiveButton(io.antmedia.android.liveVideoBroadcaster.R.string.scan_softwareupdate_install, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    showConnectionStatus(false);        // hide current dialogs because software update will display a dialog
                                    stopScanning();
                            ...
                            .setNeutralButton(io.antmedia.android.liveVideoBroadcaster.R.string.scan_softwareupdate_notnow, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    launchComponentActivity();
                                }
                            })
                            .setNegativeButton(io.antmedia.android.liveVideoBroadcaster.R.string.scan_softwareupdate_dontask, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
    ...
    public void onUpdateCompleted() {
        ...
        Toast.makeText(this, io.antmedia.android.liveVideoBroadcaster.R.string.scan_softwareupdate_completed, Toast.LENGTH_LONG).show();
    ...
    public void onUpdateFailed(boolean isDownloadError) {
        ...
        Toast.makeText(this, isDownloadError ? io.antmedia.android.liveVideoBroadcaster.R.string.scan_softwareupdate_downloaderror : io.antmedia.android.liveVideoBroadcaster.R.string.scan_softwareupdate_updateerror, Toast.LENGTH_LONG).show();
    ...
    private class PeripheralList {
        ...
        String filtersDescription() {
            ...
            if (mRssiFilterValue > kMaxRssiValue) {
                String rssiString = String.format(Locale.ENGLISH, getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_filters_name_rssi_format), mRssiFilterValue);
            ...
            if (!mIsUnnamedEnabled) {
                String namedString = getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_filters_name_named);
                if (filtersTitle != null && !filtersTitle.isEmpty()) {
            ...
            if (mIsOnlyUartEnabled) {
                String uartString = getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_filters_name_uart);
                if (filtersTitle != null && !filtersTitle.isEmpty()) {
    ...
    private class ExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private String getChildCommon(BluetoothDeviceData deviceData) {
            ...
            if (name != null) {
                result.append(getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_localname)).append(": <b>").append(name).append("</b><br>");
            }
            String address = deviceData.device.getAddress();
            result.append(getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_address)).append(": <b>").append(address == null ? "" : address).append("</b><br>");
            ...
            if (!serviceText.toString().isEmpty()) {
                result.append(getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_services)).append(": <b>").append(serviceText).append("</b><br>");
            }
            result.append(getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_txpower)).append(": <b>").append(deviceData.txPower).append("</b>");
        ...
        private String getChildBeacon(BluetoothDeviceData deviceData) {
            ...
            String kKnownManufacturers[] = getResources().getStringArray(io.antmedia.android.liveVideoBroadcaster.R.array.beacon_manufacturers_ids);
            int knownIndex = Arrays.asList(kKnownManufacturers).indexOf(manufacturer);
            if (knownIndex >= 0) {
                String kManufacturerNames[] = getResources().getStringArray(io.antmedia.android.liveVideoBroadcaster.R.array.beacon_manufacturers_names);
                manufacturer = kManufacturerNames[knownIndex];
            }

            result.append(getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_beacon_manufacturer)).append(": <b>").append(manufacturer == null ? "" : manufacturer).append("</b><br>");
            ...
            result.append(getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_uuid)).append(": <b>").append(text).append("</b><br>");
            ...
            result.append(getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_beacon_major)).append(": <b>").append(major).append("</b><br>");
            ...
            result.append(getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_beacon_minor)).append(": <b>").append(minor).append("</b><br>");
        ...
        public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = getLayoutInflater().inflate(io.antmedia.android.liveVideoBroadcaster.R.layout.layout_scan_item_title, parent, false);

                holder = new GroupViewHolder();

                holder.nameTextView = (TextView) convertView.findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.nameTextView);
                holder.descriptionTextView = (TextView) convertView.findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.descriptionTextView);
                holder.rssiImageView = (ImageView) convertView.findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.rssiImageView);
                holder.rssiTextView = (TextView) convertView.findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.rssiTextView);
                holder.connectButton = (Button) convertView.findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.connectButton);

                convertView.setTag(io.antmedia.android.liveVideoBroadcaster.R.string.scan_tag_id, holder);

            } else {
                holder = (GroupViewHolder) convertView.getTag(io.antmedia.android.liveVideoBroadcaster.R.string.scan_tag_id);
            }
            ...
            */
            ...
            holder.descriptionTextView.setText(getResources().getStringArray(io.antmedia.android.liveVideoBroadcaster.R.array.scan_devicetypes)[deviceData.type]);
            holder.rssiTextView.setText(deviceData.rssi == 127 ? getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_rssi_notavailable) : String.valueOf(deviceData.rssi));
        ...
        private int getDrawableIdForRssi(int rssi) {
            ...
            final int kSignalDrawables[] = {
                    io.antmedia.android.liveVideoBroadcaster.R.drawable.signalstrength0,
                    io.antmedia.android.liveVideoBroadcaster.R.drawable.signalstrength1,
                    io.antmedia.android.liveVideoBroadcaster.R.drawable.signalstrength2,
                    io.antmedia.android.liveVideoBroadcaster.R.drawable.signalstrength3,
                    io.antmedia.android.liveVideoBroadcaster.R.drawable.signalstrength4};
        ...
        public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = getLayoutInflater().inflate(io.antmedia.android.liveVideoBroadcaster.R.layout.layout_scan_item_child, parent, false);
            }

            // We don't expect many items so for clarity just find the views each time instead of using a ViewHolder
            TextView textView = (TextView) convertView.findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.dataTextView);
            Spanned text = getChild(groupPosition, childPosition);
            textView.setText(text);

            Button rawDataButton = (Button) convertView.findViewById(io.antmedia.android.liveVideoBroadcaster.R.id.rawDataButton);
            rawDataButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (groupPosition < filteredPeripherals.size()) {
                        ...
                        final String clipboardLabel = getString(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_advertising_title);

                        new AlertDialog.Builder(MainActivity.this)
                                .setTitle(io.antmedia.android.liveVideoBroadcaster.R.string.scan_device_advertising_title)
